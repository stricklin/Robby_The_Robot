...
if __name__ == "__main__":
    ...
    print
    print
    np.save("training_rewards_learning_rate=" + str(learning_rate), np.array(training_rewards))
    ...
    np.save("testing_rewards_learning_rate=" + str(learning_rate), np.array(testing_rewards))
